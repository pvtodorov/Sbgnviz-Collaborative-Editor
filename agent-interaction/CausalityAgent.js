 ...
 */
CausalityAgent.prototype.initCancerGeneInformation = function(cancerType,  fileContent){
    var self = this;
...
CausalityAgent.prototype.initContext = function(callback){
    var self = this;
...
CausalityAgent.prototype.isGene = function(node){
...
CausalityAgent.prototype.updateCancerRelevance = function (nodes) {
...
CausalityAgent.prototype.evaluateMessage = function(callback){
    var self = this;
...
CausalityAgent.prototype.findMostImportantNodeInContext = function(nodes, cancer){
    var self = this;
    var maxScore = -100000;
    var bestNode;
 ...
 */
CausalityAgent.prototype.updateContextSpeciesAndOrgans = function(callback){
    var self = this;
 ...
 * @param op
 */
CausalityAgent.prototype.updateContextCancer = function(callback){
    var self = this;
...
CausalityAgent.prototype.printcancerList = function(){
    this.cancerList.forEach(function(cancer){
        console.log(cancer);
    })
}
CausalityAgent.prototype.printMutationData = function(cancerData){
...
CausalityAgent.prototype.findBestContext = function(){
    var self = this;
    var likelyContext;
...
CausalityAgent.prototype.informAboutCancer = function(cancer){
...
CausalityAgent.prototype.informAboutNeighborhood = function(geneName, neighborName){
    var self = this;
...
///////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////
CausalityAgent.prototype.isInModel = function(geneName){
    var self = this;
 ...
 * @param callback
 */
CausalityAgent.prototype.findMostImportantNeighborInContext = function(tellGeneName, geneName, cancer, callback){
    var self = this;
...
CausalityAgent.prototype.suggestNewGraph = function(geneName, importantNeighborName) {
 ...
 *
 */
CausalityAgent.prototype.findAllControllingNeighbors = function(geneName, sifGraph){
