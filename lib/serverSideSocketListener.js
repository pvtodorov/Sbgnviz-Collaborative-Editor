...
module.exports.start = function(io, model, cancerDataOrganizer){
    ...
    io.sockets.on('connection', function (socket) {
        ...
        console.log(model.get('documents'));
        ...
        socket.on('subscribeHuman', function (data, callback) {
            ...
            //Listen to the messages in this room to sort them
            //To set the correct time for the messages
        ...
        //TODO: cytoscape discrepancies between agent and human
        ...
        socket.on('subscribeAgent', function (data, callback) {
            ...
            modelManagerList[data.userId] = (require('./modelManager.js')(model, data.room, data.userId, data.userName));

            modelManagerList[data.userId].setName(data.userName);


            menuList[data.userId] =  require('./app-menu.js')(modelManagerList[data.userId]);

            //send modelManager to web client
            //make sure cytoscape is loaded
            menuList[data.userId].startInNode();
