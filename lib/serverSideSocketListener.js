...
module.exports.start = function(io, model, cancerDataOrganizer){
    ...
    io.sockets.on('connection', function (socket) {
        ...
        socket.on('agentMergeGraphRequest', function(data){
                ...
                if (roomMate != null) {
                    ...
                    if(data.type == "sbgn") {
                        ...
                        clientSocket.emit('mergeJsonWithCurrent', jsonGraph); //tell clients to perform layout
                    }//default is json
                }
        ...
        socket.on('subscribeAgent', function (data, callback) {
            ...
            modelManagerList[data.userId] = (require('../public/sample-app/js/modelManager.js')(model, data.room, data.userId, data.userName));

            modelManagerList[data.userId].setName(data.userName);


            menuList[data.userId] =  require('../public/sample-app/js/app-menu.js')();
