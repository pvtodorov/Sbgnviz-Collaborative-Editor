  ...
  function listenCallback(err) {
    ...
    function createServer() {
        ...
        require('./server').setup(app, options, function (err, expressApp, upgrade, refModel) {
            ...
            cancerDataOrganizer.getCancerStudies();

             //
             // setTimeout(function () {
             //
             //     cancerDataOrganizer.getMutationCount("TP53", function(data){
             //         console.log(data);
             //     });
             //
             //
            ...
            socket.on('agentCBioPortalQueryRequest', function(data, callback){
                var proteinName = data;

                    
                cancerDataOrganizer.getMutationCount(data, function(result){
                    callback(result);
